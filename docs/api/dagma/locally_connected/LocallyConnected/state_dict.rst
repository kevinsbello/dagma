...
.. py:method:: dagma.locally_connected.LocallyConnected.state_dict(*, destination: T_destination, prefix: str = ..., keep_vars: bool = ...) -> T_destination
               dagma.locally_connected.LocallyConnected.state_dict(*, prefix: str = ..., keep_vars: bool = ...) -> Dict[str, Any]
